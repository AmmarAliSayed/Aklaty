//
//  HealthyFoodItemDetailsViewController.swift
//  Aklaty
//
...
import Gallery
class HealthyFoodItemDetailsViewController: UIViewController {
    //MARK: - outlets
        ...
        var itemDetailsViewModel : HealthyFoodItemDetailsViewModel!
        var orderNum :Int = 1
    ...
    //MARK: - IBActions
     @IBAction func orderButtonPressed(_ sender: Any) {
      ...
      // itemDetailsViewModel.saveHealthyFoodItemToBasket()
        addNewOrderedItem()
     }
...
//        }
     ...
     func updateItem(){
         ...
         descriptionLabel.text = itemDetailsViewModel.itemData.description
         timeLabel.text = itemDetailsViewModel.itemData.time
         if let price = itemDetailsViewModel.itemData.price,let calories = itemDetailsViewModel.itemData.calories{
             priceLabel.text = "$\(price)"
             newPrice = price
             oldPrice = price
    ...
    func addNewOrderedItem(){
        ...
        itemDetailsViewModel.addOrderedHealthyFoodToFirebase(item: item)
        itemDetailsViewModel.saveOrderedHealthyFoodItemToBasket(item: item)
    }
...
extension HealthyFoodItemDetailsViewController : UITableViewDelegate , UITableViewDataSource{
