//
//  FreeDeliveryItemDetailsViewController.swift
//  Aklaty
//
...
import Gallery
class FreeDeliveryItemDetailsViewController: UIViewController {
    ...
    //MARK: - outlets
      ...
      //  @IBOutlet weak var discountRateLabel: UILabel!
       ...
       // @IBOutlet weak var descriptionLabel: UILabel!
        ...
        var itemDetailsViewModel : FreeDeliveryOfferDetailsViewModel!
...
//        }
    ...
    func addNewOrderedItem(){
        ...
        itemDetailsViewModel.addOrderedFreeDeliveryItemToFirebase(item: item)
        itemDetailsViewModel.saveFreeDeliveryItemToBasket(item: item)
    }
...
extension FreeDeliveryItemDetailsViewController : UITableViewDelegate , UITableViewDataSource{
