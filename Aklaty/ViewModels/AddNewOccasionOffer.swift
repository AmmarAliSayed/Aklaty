...
import Foundation
class AddNewOccasionOffer: NSObject {
    //property from model
    ...
    func addOccasionOfferToFirebase(offer:OccasionOffer){
        shouldStartLoading()
        fireStoreService.saveOccasionOfferFirestore(offer) { (error) in
